...
<Image style={{height:100,width:70,bottom:300,left:40}} source={{uri: "https://www.jing.fm/clipimg/full/288-2885551_stopwatch-icon.png"}} />
        ...
        <TouchableHighlight style={[styles.buttonContainer, styles.loginButton]} onPress={() => this.onClickListener('Sigin')}>
          <Text style={styles.loginText}>Create Account</Text>
        </TouchableHighlight>
        

        <TouchableHighlight style={[styles.buttonContainer, styles.loginButtons]} onPress={() =>  this.props.navigation.navigate('Delivery')}>
